      ...
      {messages.map((message) => (
        <div
          ...
          className={`flex items-start ${
            message.sender === "user" ? "justify-end space-x-2" : "space-x-2"
          }`}
        >
          {message.sender === "ai" && (
          ...
          >
            {typeof message.content === "string" ? (
              ...
              <div>
                ...
                />
                {message.content.alt &&
                  message.content.alt !== "Imagem enviada pelo usuário" && (
          ...
          <div className="bg-gray-100 dark:bg-gray-700 rounded-lg p-4 max-w-[80%] flex items-center">
            <div className="typing-indicator flex space-x-1">
              <span
                ...
                style={{ "--dot-index": 0 } as any}
              ></span>
              <span
                className="w-2 h-2 bg-gray-500 dark:bg-gray-400 rounded-full"
                style={{ "--dot-index": 1 } as any}
              ></span>
              <span
                className="w-2 h-2 bg-gray-500 dark:bg-gray-400 rounded-full"
                style={{ "--dot-index": 2 } as any}
              ></span>
            </div>
          </div>
        </div>
